...
<%@page import="com.flowerstore.dao.CategoriesDAO"%>
<%@page import="com.flowerstore.model.Categories"%>
<%@page import="com.flowerstore.model.Product"%>
<%@page import="com.flowerstore.dao.ProductDAO"%>
